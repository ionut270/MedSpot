            ...
            <>
                ...
                <Modal visible={showCabinets} footer={[
                    ...
                    {!cabinets.candidates ? <Empty description='We could not find any cabinets on the selected specialization in your area !' /> : cabinets.candidates.map((cabinet, key) => {
                        ...
                        return <Card className="cabinet_card" hoverable={true} key={key} size="small" title={cabinet.name} extra={cabinet.opening_hours ? cabinet.opening_hours.open_now ? "Open" : "Closed" : ''}>
                            ...
                            <Popover key="key" content={content} title="Phone Number" onMouseEnter={(e) => {
                                e.preventDefault();
